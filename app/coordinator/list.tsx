...
import { createPreceptor, deletePreceptor, listPreceptors } from "../../src/components/services/preceptor"; // ajuste nome se estiver preceptor.js
...
export default function CoordinatorListScreen() {
      ...
      <View style={[styles.container, isWide && styles.containerWide]}>
        ...
        <View style={styles.box}>
          <FlatList
            ...
            ListEmptyComponent={!loadingCalls ? <Text style={{ color: COLORS.muted }}>Nenhuma chamada salva.</Text> : null}
            contentContainerStyle={rollcalls.length === 0 ? { padding: 20, alignItems: 'center' } : undefined}
          />
        </View>
        ...
        >
          ...
          <View style={styles.modalList}>
            {/* Using simple map inside ScrollView instead of nested FlatList to avoid conflicts */}
            {ubsList.map((item) => (
...
const styles = StyleSheet.create({
  ...
  modalCard: { backgroundColor: COLORS.white, padding: 14, borderTopLeftRadius: 18, borderTopRightRadius: 18, maxHeight: "85%" },
